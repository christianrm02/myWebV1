...
const typed = new Typed('#mi_parrafo', {
  strings: [`Buenas! Soy Christian Rivero Marin (CRM), actualmente tengo ${edad} años, nací en Barcelona el 20 de abril del 2002 y soy Ingeniero informático, concretamente, de la especialidad de Ingeniería del Software, titulado en la UPC. Desde pequeño me han llamado mucho la atención los ordenadores, las consolas, los diseños de las páginas web, y sobre todo, el porqué de las cosas. Me considero una persona muy curiosa, que le gusta aprender lo desconocido y conocer diferentes puntos de vista de todo tipo de persona. Soy trabajador, perfeccionista, perseverante, resolutivo y con capacidad de trabajar en equipo. Si estás leyendo esto es porque o estoy presumiendo de página web (está bien hecha eh <img src="/images/guiño3.png" alt="emoticono guiño" id="emote_guiño"/> ) o estás aquí interesado en mí y en mi portafolio. En ese caso, espero que te sirva esta web para conocerme un poco más, y si necesitas conocerme mejor, contáctame por privado desde <a href="#bloque4" id="contacto_ref">aquí</a>.`],
  typeSpeed: 35,
});
